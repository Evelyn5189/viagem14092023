...
<body  class="text-center d-flex align-items-center" style="height: 100vh; background-image: url('assets/images/fundo/tucano.jpg'); background-position: 20% 40%;">
  <section style=" margin: auto; width:500px; height:500px display:flex; align-items:center; justify-content:center;">
    <form method="post" action="processar-login.php" class="form-signin border rounded p-5" style="background-color:white; margin: auto; width:500px; height:500px display:flex; align-items:center; justify-content:center;">
